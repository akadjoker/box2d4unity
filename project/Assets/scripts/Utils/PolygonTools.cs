...
namespace Utils
{
    public static class PolygonTools
    {
                                                      ...
                                                      int segments)
        {
           ...
           // Debug.Assert(Box2D.Settings.b2_maxPolygonVertices >= 8);
            ...
            else
            {
                ...
                FVector2 posOffset = new FVector2(width / 2 - xRadius, height / 2 - yRadius);
                ...
                for (int i = 1; i < numberOfEdges; i++)
                {
                    ...
                    vertices.Add(posOffset + new FVector2(xRadius * (float)Math.Cos(stepSize * -(i + phase)),
        ...
        public static Vertices CreateEllipse(float xRadius, float yRadius, int numberOfEdges)
        {
            ...
            for (int i = numberOfEdges - 1; i > 0; --i)
                vertices.Add(new FVector2(xRadius * (float)Math.Cos(stepSize * i),
        ...
        public static Vertices CreateArc(float radians, int sides, float radius)
        {
            ...
            {
                vertices.Add(new FVector2(radius * (float)Math.Cos(stepSize * i),
                                             ...
                                             int bottomEdges)
        {
            ...
            {
                vertices.Add(new FVector2(topRadius * (float)Math.Cos(stepSize * i),
            ...
            {
                vertices.Add(new FVector2(-bottomRadius * (float)Math.Cos(stepSize * i),
