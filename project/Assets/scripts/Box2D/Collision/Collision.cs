...
namespace Box2D
{
	        ...
	        case ManifoldType.Circles:
		        {
			        ...
			        if (Vector2.Distance(pointA, pointB) > Settings.b2_epsilon * Settings.b2_epsilon)
			        {
    ...
    public static class Collision
    {
							           ...
							           CircleShape circleB, ref Transform xfB)
        {
	        ...
	        if (u1 <= 0.0f)
	        {
		        if (Vector2.Distance(cLocal, v1) > radius * radius)
		        {
			        return;
		        }
	        ...
	        {
		        if (Vector2.Distance(cLocal, v2) > radius * radius)
		        {
			        return;
		        }
